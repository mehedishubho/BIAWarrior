    ...
    <div class="theme-tabs d-md-none">
      ...
      <div id="tabcontainer-2">
        <div id="tabcontent1-2" class="tabs">
          ...
          <a href="https://bdtchain.com/programs/" class="btn btn-primary">Learn More</a>
        </div>
        <div id="tabcontent2-2" class="tabs">
          ...
          <a href="https://bdtchain.com/events/" class="btn btn-primary">Learn More</a>
        </div>
        <div id="tabcontent3-3" class="tabs">
          <h4>Wellness Getaways for the <br />Mind, Body & Soul</h4>
          <a href="https://bdtchain.com/the-retreat/" class="btn btn-primary">Learn More</a>
        </div>
      </div>
    </div>
    <div class="coaching-grid d-md-block d-none">
      <div class="row">
        <div class="col-md-4">
          ...
          <h3>
            <a href="https://bdtchain.com/programs/">
              Fitness Programs <br />
              for Women
            </a>
          </h3>
        ...
        <div class="col-md-4">
          ...
          <h3>
            <a href="https://bdtchain.com/events/">Mindful Mornings and <br />Empowering Experiences</a>
          </h3>
        </div>
        <div class="col-md-4">
          <img
          ...
          <h3>
            <a href="https://bdtchain.com/the-retreat/">Wellness Getaways for <br />the Mind, Body & Soul</a>
          </h3>
        </div>
      </div>
    </div>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              ...
              <div class="our-programs-obstacle">
                ...
                <a href="https://bdtchain.com/obstacle-program/" class="btn btn-light">Discover the program</a>
              </div>
            </div>
            <div class="swiper-slide">
              <img
              ...
              <div class="our-programs-obstacle">
                ...
                <a href="https://bdtchain.com/warrior-strong/" class="btn btn-light">Discover the program</a>
              </div>
            </div>
            <div class="swiper-slide">
              <img
              ...
              <div class="our-programs-obstacle">
                ...
                <a href="https://bdtchain.com/bia-mama/" class="btn btn-light">Discover the program</a>
              </div>
            </div>
            <div class="swiper-slide">
              <img
              ...
              <div class="our-programs-obstacle">
                ...
                <a href="https://bdtchain.com/bia-girls/" class="btn btn-light">Discover the program</a>
              </div>
            </div>
          </div>
...
<section class="cta-programs">
  <div class="container-fluid">
    <div class="cta-programs-text">
      ...
      <a href="https://bdtchain.com/programs/" class="btn btn-primary">Check out the programs</a>
    </div>
  </div>
</section>
