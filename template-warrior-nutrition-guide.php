...
Template Name: warrior-nutrition-guide
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6 pe-lg-5 text-center">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/free-resources/nutrition-guide.png" class="img-fluid guide-img" alt="" />
      </div>
      <div class="align-items-center col-lg-6 d-flex justify-content-center ps-lg-5">
        <div class="guide-form-wrapper">
          <h1 class="page-title text-center">Warrior Nutrition Guide</h1>
          <form id="subscribeForm" class="theme-form">
            <div class="form-wrapper">
              <label for="sName">Name</label>
              <input type="text" id="sName" class="form-control" placeholder="Enter your name" required="" />
            </div>
            <div class="form-wrapper">
              <label for="sEmail">Email</label>
              <input type="email" id="sEmail" class="form-control" placeholder="Your Email Address" required="" />
            </div>
          ...
          emailjs
            ...
            .then(
              function(response) {
                ...
                link.href = "assets/pdf/BiaWarriorMealPlan.pdf";
                link.download = "BiaWarriorMealPlan.pdf";
